...
// SAD: all booked
let allBooked = [];
let slotTime = moment("2025-09-01 09:00", "YYYY-MM-DD HH:mm");
let endTime = moment("2025-09-01 12:00", "YYYY-MM-DD HH:mm");
while (slotTime.clone().add(30, "minutes").isSameOrBefore(endTime)) {
    ...
    allBooked.push({ date: "2025-09-01", day: "Mon", slotId: "", start: s, end: e });
    slotTime = slotTime.clone().add(40, "minutes"); // duration + gap
}
generateServiceAvailability(serviceRules, "2025-09-01", allBooked, [], "SAD: All booked");
...
generateServiceAvailability(
    ...
    "2025-09-01",
    [{ date: "2025-09-01", day: "Mon", slotId: "", start: "09:00", end: "09:30" }],
    [{ date: "2025-09-01", day: "Mon", slotId: "", start: "10:20", end: "10:50" }],
    "MIXED: Some booked, some reserved, rest free"
);
